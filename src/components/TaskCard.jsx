...
import { Trash2, Calendar, Flag, AlertTriangle, ImageIcon } from 'lucide-react';
    ...
    <Draggable draggableId={task._id} index={index}>
      {(provided, snapshot) => (
        <div
          ...
          className={`relative rounded-xl border overflow-hidden cursor-pointer transition-all duration-200 group
            ${snapshot.isDragging
